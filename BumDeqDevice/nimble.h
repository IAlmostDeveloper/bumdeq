...
void initNimBLEServer() {
  ...
  pFoodCharacteristic->setValue(String(30+random(-5,5)));
  ...
  if (pServer->getConnectedCount()) {
    ...
    if (pSvc) {
        ...
        if (pChr) {
            ...
            pChr->setValue(newValue.c_str());
            pChr->notify();
            Serial.println("ble_notify value: " + newValue);
        }
    }
  }
}
